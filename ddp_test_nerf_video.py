...
def ddp_test_nerf(rank, args):
    ...
    for split in render_splits:
        ...
        def get_box_props(box_number):
            ...
            box_props =  np.array([[0.5, 0.1, 0.9, 1,1,1, 0, 0, 35], [0.9, 0.1, 0.4, 1,1,1, 0, 0, 35], [0.2, 0.9, 0.5, 1,1,1, 0, 0, 35], [0.6, 0.7, 0.9, 1,1,1, 0, 0, 35], [0.3, 0.5, 0.3, 1,1,1, 0, 0, 35],
                                  [0.4, 0.6, 0.5, 1,1,1,0, 0, 35],[0.8, 0.2, 0.2, 0.5,2,1,0, 0, 0], [0.4, 0.4, 0.9, 2,2,2, 0, 0, 35], [0.8, 0.1, 0.8, 3,2,1, 20, 0, 0]])
